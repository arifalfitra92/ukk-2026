...
<style>
    /* =========================================================
       EDIT KATEGORI - MOUNTAIN GREEN THEME
       ========================================================= */
            ...
            <div class="col-lg-8 col-xl-7">
                ...
                <div class="kategori-header">
                    ...
                    <p class="kategori-description small mb-0">
                        Perbarui informasi data kategori inventaris
                        agar data tetap akurat dan terorganisir.
                    </p>
                ...
                <div class="kategori-form-card">
                    ...
                    <div class="kategori-form-body">
                        ...
                        <form
                            action="{{ route('kategori.update', ['id_kategori' => $data->id_kategori]) }}"
                            method="POST"
                        >
